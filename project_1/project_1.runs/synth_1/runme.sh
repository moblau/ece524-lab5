...
HD_PWD='C:/Users/joeba/OneDrive/Documents/524lab/5/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log string_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source string_detector.tcl

...
HD_PWD='C:/Users/joeba/OneDrive/Documents/524lab/5/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log string_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source string_detector.tcl -notrace
